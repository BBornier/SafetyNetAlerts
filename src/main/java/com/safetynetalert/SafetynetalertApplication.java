...
public class SafetynetalertApplication implements CommandLineRunner {
	...
	public static void main(String[] args) throws JSONException, IOException, ParseException {
		...
		// parser objet Json avec une méthode sans JSONParser pour afficher noms et
		// prénoms au level 2 du Json.
		...
		// JSONObject jsonGet = (JSONObject) jsonObject2.get("persons"); // Ecrit avec
		// Raph. à mettre dans la couche controller (?) StackTrace : org.json.JSONArray
		// and org.json.JSONObject are in unnamed module of loader 'app'

		Person person = new Person();
		person.setId(1); // set les paramètres
		// person.setFirstName(jsonObject2.getString("firstName")); // Ecriture avec
		// Julien. Set un objet Json en paramètre pour un objet Java. StackTrace :
		// JSONObject["firstName"] not found.
		// person.setFirstName((String) jsonObject2.get("firstName")); // Ecriture avec
		// Raph. Correspondance entre objet java et JsonObject.
